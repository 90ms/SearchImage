...
object NetworkCoreModule {
    ...
    @Provides
    @Named(HOST_NAVER)
    fun provideHostNaver() = HOST_NAVER
                ...
                Interceptor { chain ->
                    val requestBuilder =
                        chain
                            ...
                            .addHeader(
                                "X-Naver-Client-Id",
                                context.getString(com.a90ms.common.R.string.naver_client_id)
                            )
                            .addHeader(
                                "X-Naver-Client-Secret",
                                context.getString(com.a90ms.common.R.string.naver_client_secret)
                            )
